...
public class AddressResourceIntTest {
    ...
    private static final Integer DEFAULT_ADRESS_ID = 1;
    private static final Integer UPDATED_ADRESS_ID = 2;
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAdressId()).isEqualTo(DEFAULT_ADRESS_ID);
        assertThat(testAddress.getAdress()).isEqualTo(DEFAULT_ADRESS);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].adressId").value(hasItem(DEFAULT_ADRESS_ID)))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.adressId").value(DEFAULT_ADRESS_ID))
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getAdressId()).isEqualTo(UPDATED_ADRESS_ID);
        assertThat(testAddress.getAdress()).isEqualTo(UPDATED_ADRESS);
